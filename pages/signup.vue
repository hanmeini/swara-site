<template>
    <section class="px-10 my-20 md:my-0 lg:my-0 md:px-20 md:py-20 flex justify-between items-center content-center h-screen flex-col lg:flex-row">
        <!-- Image -->
        ...
        <div class="flex flex-col justify-center items-center w-full h-full mt-5" >
            <h1 class="font-semibold md:text-3xl mb-2 md:mb-4"><span class="text-[#A52A2D]">Daftar</span> Sekarang</h1>
